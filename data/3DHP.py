...
def generate_heatmaps_and_fill_dataset(entry, model, split, datadir, sample_interesting_frames=False):
    ...
    if split == 'train': subject_list = subjects_train
    else: subject_list = subjects_test
    for subject in subject_list:
        ...
        for idx, (fn_img, pose_3d_uni, pose_3d, pose_2d, valid) in enumerate(zip(images, poses_3d_uni, poses_3d, poses_2d, valid_frames)):
            ...
            entry["gt_3d"]      = pose_3d.reshape(17, 3).T
            entry["gt_3d_uni"]  = pose_3d_uni.reshape(17, 3).T
            entry["gt_2d"]      = pose_2d.reshape(17, 2).T
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str,
                        ...
                        default='../mpi_inf_3dhp/mpi_inf_3dhp_test_set/')
